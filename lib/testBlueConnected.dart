...
import 'package:flutter_blue_map/testBlueSend.dart';
import 'package:permission_handler/permission_handler.dart';


class testBlueConnectedPage extends StatefulWidget {
  testBlueConnectedPage(ScanResult this.scan);

  ScanResult scan;

  @override
  testBlueConnectedState createState() => testBlueConnectedState();
}

class testBlueConnectedState extends State<testBlueConnectedPage> {
