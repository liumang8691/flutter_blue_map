...
import 'package:flutter_blue_map/testBlueConnected.dart';
...
class testBlueState extends State<testBluePage> {
  ...
  void connectToBlueDevice(ScanResult model) async{
    ...
    Navigator.of(context).push(MaterialPageRoute(builder: (context) => testBlueConnectedPage(model)));
    return;
